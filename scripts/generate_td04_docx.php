...
/**
 * One-off generator: td_04_sqlite_migration_audit.md → .docx (Office Open XML).
...
$mdPath = $root . '/docs/reports/td_04_sqlite_migration_audit.md';
$outPath = $root . '/docs/reports/td_04_sqlite_migration_audit.docx';
