...
/**
 * Generator: td_04_implementation_report.md → .docx (Office Open XML).
...
$mdPath = $root . '/docs/reports/td_04_implementation_report.md';
$outPath = $root . '/docs/reports/td_04_implementation_report.docx';
