    ...
    <div class="bg-zinc-50 min-h-screen pb-10" dir="rtl"
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-black text-zinc-900">إنشاء حملة إعلانية</h1>
                    <p class="text-sm text-zinc-500 mt-1">اختر الموضع والمدة ثم ارفع البانر للدفع</p>
                </div>
            ...
            <form action="{{ route('dashboard.ads.store') }}"
                ...
                <div class="bg-white rounded-2xl border border-zinc-100 p-6 space-y-5" style="box-shadow:0 1px 6px rgba(0,0,0,0.05);">
                    ...
                    <div>
                        <label for="title" class="block text-sm font-bold text-zinc-700 mb-2">عنوان الحملة</label>
                        <input type="text"
                               id="title"
                               name="title"
                               value="{{ old('title') }}"
                    ...
                    <div>
                        <label for="placement" class="block text-sm font-bold text-zinc-700 mb-2">موضع الإعلان</label>
                        <select id="placement"
                                name="placement"
                                x-model="placement"
                                required
                    ...
                    <div x-show="placement === 'category_page'" x-cloak>
                        <label for="category_id" class="block text-sm font-bold text-zinc-700 mb-2">التصنيف</label>
                    ...
                    <div>
                        <label for="target_url" class="block text-sm font-bold text-zinc-700 mb-2">رابط الهدف</label>
                        <input type="url"
                               id="target_url"
                               name="target_url"
                    ...
                    <div>
                        <label for="ad_image" class="block text-sm font-bold text-zinc-700 mb-2">صورة البانر</label>
                        <input type="file"
                               id="ad_image"
                               name="ad_image"
                        ...
                        <p class="text-xs text-zinc-500 mt-2">صور فقط (JPEG, PNG, WebP, GIF) — الحد الأقصى 2 ميجابايت</p>
                    </div>

                    <div>
                        <label for="duration_days" class="block text-sm font-bold text-zinc-700 mb-2">مدة الحملة</label>
