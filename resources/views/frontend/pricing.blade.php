            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 items-stretch">
                ...
                <div class="flex flex-col h-full bg-white rounded-2xl border border-zinc-200 p-4 sm:p-5 shadow-sm">
                    ...
                    <ul class="space-y-2.5">
                        @foreach([
                            ['M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'إنشاء حساب', '+15'],
                            ['M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', 'توثيق الهاتف', '+15'],
