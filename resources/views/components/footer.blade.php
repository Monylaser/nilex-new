{{-- ════════════════════════════════════════════════════════════════
     ...
     bg: #0f172a | accent: #14A5A8 (nilex-teal) | RTL Arabic
════════════════════════════════════════════════════════════════ --}}
@php
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 mb-14">
            ...
            <div class="col-span-2 md:col-span-3 lg:col-span-1">
                ...
                <div class="flex gap-3">
                    <a href="#" aria-label="{{ __('ui.footer.social_facebook') }}"
                    ...
                    <a href="#" aria-label="{{ __('ui.footer.social_twitter') }}"
                    ...
                    <a href="#" aria-label="{{ __('ui.footer.social_instagram') }}"
                    ...
                    <a href="#" aria-label="{{ __('ui.footer.social_youtube') }}"
            ...
            <div>
                <h4 class="text-white font-bold text-sm mb-5 flex items-center gap-2">
                    <span class="w-1 h-4 rounded-full inline-block" style="background:#14A5A8;"></span>
            ...
            <div>
                <h4 class="text-white font-bold text-sm mb-5 flex items-center gap-2">
                    <span class="w-1 h-4 rounded-full inline-block" style="background:#0D7377;"></span>
            ...
            <div>
                <h4 class="text-white font-bold text-sm mb-5 flex items-center gap-2">
                    <span class="w-1 h-4 rounded-full inline-block" style="background:#14BDBC;"></span>
                    {{ __('ui.footer.contact') }}
                </h4>
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start gap-3">
                        <svg class="w-4 h-4 mt-0.5 shrink-0" style="color:#14A5A8;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
