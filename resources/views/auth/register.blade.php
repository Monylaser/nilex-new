<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        {{-- كلمة المرور --}}
        <div>
            <label class="block text-sm font-semibold text-gray-700 mb-1.5" for="reg-password">{{ __('ui.auth.label_password') }}</label>
            <x-password-input
                name="password"
                id="reg-password"
        ...
        {{-- تأكيد كلمة المرور --}}
        <div>
            <label class="block text-sm font-semibold text-gray-700 mb-1.5" for="password_confirmation">{{ __('ui.auth.label_password_confirm') }}</label>
            <x-password-input
