...
return [
    ...
    'auth' => [
        ...
        'otp_locked_minutes' => 'محاولات كثيرة. حاول مجدداً بعد :minutes دقيقة.',
        'otp_resend_cooldown' => 'يرجى الانتظار :seconds ثانية قبل إعادة إرسال الكود.',
    ...
    'offer' => [
        ...
        'rate_limit_exceeded' => 'تمهل قليلاً — أرسلت عروضاً كثيرة. حاول مرة أخرى بعد :seconds ثانية.',
    ],
    ...
    'review' => [
        ...
        'rate_limit_exceeded' => 'تمهل قليلاً — أرسلت تقييمات كثيرة. حاول مرة أخرى بعد :seconds ثانية.',
    ],
